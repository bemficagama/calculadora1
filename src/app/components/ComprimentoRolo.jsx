...
export default function ComprimentoRolo() {
    ...
    const updateComprimento = () => {
        const comprimentoTemp = Math.round(((+peso / +quantidade / (+gramatura / 100000) * 1) / +largura) * 100) / 100

        setComprimento(comprimentoTemp ? comprimentoTemp : 0.00)
    }
    ...
    return (
        <>
            ...
            <div className="col text-center">
                <Resultado resultado={comprimento} titulo="Comprimento (m)" />
            </div>
